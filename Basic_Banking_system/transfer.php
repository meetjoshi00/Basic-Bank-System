...
<head>
    ...
    <title>Basic Banking | Transfer</title>
...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:#fff; opacity:1;">
            ...
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:black;font-family: 'Lemonada', cursive; font-size: 30px;font-size:2em;">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:#7B0202;font-weight:1em;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="viewallcustomers.php" style="color:#7B0202;font-weight:1em;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferhistory.php" style="color:#7B0202;font-weight:1em;">
                            <div style="padding-left:20px;" >
...
if ($result->num_rows > 0) {
 ...
 if($amount>$row["current_balance"] or $row["current_balance"]-$amount<100){
    echo "<script>swal( 'Transaction Failed','Low on Balance','error' ).then(function() { window. location = 'viewallcustomers.php'; });;</script>";
...
if($flag==true){
echo "<script>swal('Done', 'Amount Tranferred','success').then(function() { window. location = 'viewallcustomers.php'; });;</script>";
}
elseif($flag==false)
{
    echo "<script>
